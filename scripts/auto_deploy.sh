...
#
#   - EDITED (Git Metadata Telegram Injection - 2026-07-03):
#     • Upgraded `notify()` to consume `.deploy_meta` generated by Engine A and format Telegram payloads with explicit Git Hash, Message, and Timestamps.
#     • Reason: Engine B executes outside the Git repository boundary. To satisfy the auditable notification requirement, Engine A explicitly crosses the execution boundary by writing metadata locally.
# ==============================================================================
