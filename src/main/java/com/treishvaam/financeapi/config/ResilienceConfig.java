...
public class ResilienceConfig {
     ...
     * requests) if 50% of requests fail. - Waits 30 seconds before testing if the external service
     * is back up. - Uses a sliding window of the last 10 requests to calculate the error rate.
     */
    @Bean
