...
public class BlogPostController {
    ...
    public ResponseEntity<BlogPost> createPost(
            ...
            @RequestParam(value = "displaySection", defaultValue = "STANDARD")
            ...
            @RequestParam(value = "newThumbnails", required = false)
                    List<MultipartFile> newThumbnails,
            @RequestParam(value = "thumbnailMetadata", required = false)
                    String thumbnailMetadataJson,
