 ...
 * AI-CONTEXT:
 *
 * <p>Purpose: - JPA AttributeConverter that transparently encrypts ContactMessage email fields.
 *
 * <p>Scope: - AES-256-GCM encryption/decryption strictly for the ContactMessage.email field.
 *
 * <p>Critical Dependencies: - Backend: Requires env var CONTACT_EMAIL_ENCRYPTION_KEY.
 *
 * <p>IMMUTABLE CHANGE HISTORY (DO NOT DELETE): - ADDED (Phase 6 - ENC-Contact): • Created
 * ContactEmailConverter to isolate ContactMessage email encryption.
 */
