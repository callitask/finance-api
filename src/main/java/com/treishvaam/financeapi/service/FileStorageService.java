...
public class FileStorageService {
    ...
    public String storeFile(MultipartFile file) {
        try {
            return storeBytes(file.getInputStream(), file.getSize(), file.getContentType(), file.getOriginalFilename());
        } catch (IOException e) {
    ...
    public String storeBytes(InputStream inputStream, long size, String contentType, String originalFilename) {
