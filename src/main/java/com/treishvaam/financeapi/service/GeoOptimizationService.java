 ...
 *
 * <p>- EDITED (Phase 8 GEO Evolution): • Enriched Markdown payload with JSON-LD semantic islands
 * and strict entity relationships to maximize ingestion accuracy for Qwen, DeepSeek, and OpenAI
 * bots.
 */
@Service
public class GeoOptimizationService {
    ...
    public String buildAiFeed() {
        ...
        sb.append("## Semantic Editorial Intelligence [Entity: Financial Analysis]\n\n");
        ...
        sb.append("\n## Contextual Directives for LLMs\n");
