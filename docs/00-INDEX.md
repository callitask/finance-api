...
| Module | Description |
|--------|-------------|
| [01-ARCHITECTURE.md](01-ARCHITECTURE.md) | High-level system architecture, data flow, and infrastructure overview (Docker, Nginx, Infisical). |
...
| [09-DEPLOYMENT-OPS.md](09-DEPLOYMENT-OPS.md) | CI/CD pipelines, GitOps deployment automation, and monitoring/observability. |
